...
#define SBAT_VAR_COLUMNS \
	((sizeof(struct sbat_var_entry) - sizeof(list_t)) / sizeof(CHAR8 *))
...
#define SBAT_SECTION_COLUMNS \
	(sizeof(struct sbat_section_entry) / sizeof(CHAR8 *))

EFI_STATUS
parse_sbat_section(char *section_base, size_t section_size, size_t *n,
                   struct sbat_section_entry ***entriesp);
void cleanup_sbat_section_entries(size_t n,
